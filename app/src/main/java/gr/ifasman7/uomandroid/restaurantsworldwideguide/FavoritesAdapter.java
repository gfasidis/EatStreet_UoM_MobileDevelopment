...
public class FavoritesAdapter extends ArrayAdapter<Restaurant> {
    ...
    public FavoritesAdapter(@NonNull Context context, int resource, @NonNull List<Restaurant> objects) {
